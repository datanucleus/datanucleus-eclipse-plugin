...
import org.datanucleus.ide.eclipse.jobs.SchemaToolDbinfoJob;
import org.eclipse.jdt.core.IJavaProject;
import org.eclipse.jface.action.IAction;
import org.eclipse.ui.IActionDelegate;

/**
 * Action invoked when the user selects the popup menu option "SchemaTool DBinfo" from a Java project.
 */
public class SchemaToolDbinfoAction extends JavaProjectAction
{
    /**
    ...
    public void run(IAction action)
    {
        ...
        {
        	SchemaToolDbinfoJob job = new SchemaToolDbinfoJob(javaProject);
            job.setUser(true);
            job.schedule();
        }
    }
