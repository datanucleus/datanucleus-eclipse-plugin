...
public abstract class JavaProjectAction implements IObjectActionDelegate {
    ...
    /**
     * Gets the associated {@link IAction}, if {@link #selectionChanged(IAction, ISelection)
     * selectionChanged(...)} or {@link #setActivePart(IAction, IWorkbenchPart) setActivePart(...)} were
     * already invoked.
    ...
    /**
     * Gets the current {@link IWorkbenchPart}, if {@link #setActivePart(IAction, IWorkbenchPart)} was already
     * invoked.
     ...
     * @return the current selection, if it is an instance of {@link IStructuredSelection}; otherwise
     * <code>null</code>.
     */
            ...
            for (Iterator<?> it = selection.iterator(); it.hasNext();)
            {
                ...
                if (element instanceof IProject)
                {
                    ...
                    if (project.hasNature(JavaCore.NATURE_ID))
                    {
                        ...
                        if (javaProject != null)
                        { // should never happen, but better play safe ;-)
