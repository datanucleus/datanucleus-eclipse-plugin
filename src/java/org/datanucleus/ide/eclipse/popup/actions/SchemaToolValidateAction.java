...
import org.datanucleus.ide.eclipse.jobs.SchemaToolValidateJob;
import org.eclipse.jdt.core.IJavaProject;
import org.eclipse.jface.action.IAction;
import org.eclipse.ui.IActionDelegate;

/**
 * Action invoked when the user selects the popup menu option "SchemaTool Validate" from a Java project.
 */
public class SchemaToolValidateAction extends JavaProjectAction
{
    /**
    ...
    public void run(IAction action)
    {
        ...
        {
        	SchemaToolValidateJob job = new SchemaToolValidateJob(javaProject);
            job.setUser(true);
            job.schedule();
        }
    }
