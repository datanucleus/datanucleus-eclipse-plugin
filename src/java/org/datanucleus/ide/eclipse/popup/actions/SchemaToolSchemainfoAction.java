...
/**
 * Action invoked when the user selects the popup menu option "SchemaTool Schemainfo" from a Java project.
 */
public class SchemaToolSchemainfoAction extends JavaProjectAction
{
    ...
    public void run(IAction action)
    {
        ...
        {
        	SchemaToolSchemainfoJob job = new SchemaToolSchemainfoJob(javaProject);
            job.setUser(true);
            job.schedule();
        }
    }
